...
base_path = Path("/amax/home/chendian/dataset")
    ...
    def __getitem__(self, index):
        try:
            if self.mode == 'relative':
                ...
                if self.split == 'train':
                    reference_image_path = base_path / 'fashionIQ' / 'images' / f"{reference_name}.jpg"
                    reference_image = self.preprocess(PIL.Image.open(reference_image_path))
                    target_name = self.triplets[index]['target']
                    target_image_path = base_path / 'fashionIQ' / 'images' / f"{target_name}.jpg"
                ...
                image_path = base_path / 'fashionIQ' / 'images' / f"{image_name}.jpg"
